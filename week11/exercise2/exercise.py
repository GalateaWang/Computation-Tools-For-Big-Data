...
xData = bagOfWords( merged_json, "body" )
print("------ %s seconds ------" % (time() - start_time))
time2 = time()
minhashed = ( minhash(xData, 3)	)
...
# Bins are similar
print merged_json[18]["body"]
print merged_json[19]["body"] 
print merged_json[20]["body"]

# NOTE: first 2 articles exactly the same